...
def resonant_HH_ggtautau_preselection(events, photons, electrons, muons, taus, jets, dR, Category_pairsLoose, options, debug):
    """
    Performs HH->ggtautau preselection for resonant analysis, requiring >=1 (leptons + tau_h).
    Currently equivalent to the SM analysis
